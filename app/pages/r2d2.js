...
// Каждый метод имеет проверки: 1) на NaN -- ввели бред;
// 2) на undefined -- пропустили аргумент или вызвали метод без аргументов;
// 3) в методах, которые используют сложение должны обрабатываться строчные значения.
// Проверка должна возвращать человекопонятную ошибку.
...
// Это правильно, что сначала должна срабатывать проверка на "undefined",
// затем проверка на "NaN" ???
